...
class Binance {
  ...
  async getFundingAccountTokenAmountMap() {
    if (this.fundingAccountTokenAmountMap.size > 0) {
      console.log('fundingAccountTokenAmountMap', this.fundingAccountTokenAmountMap);
  ...
  async getTradingAccountTokenAmountMap() {
    if (this.tradingAccountTokenAmountMap.size > 0) {
